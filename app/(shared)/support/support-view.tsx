      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 border-2 border-primary/15 text-primary mb-3">
    ...
    <section className="py-20 bg-gray-50">
      <div className="container px-4 md:px-6 mx-auto max-w-5xl">
        <motion.div
          ...
          className="text-center mb-12"
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-4 tracking-tight">Articoli dal Blog</h2>
          <p className="text-gray-600 text-lg">Le guide più consultate dai nostri utenti</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            <div className="bg-linear-to-br rounded-4xl from-blue-50 to-blue-100 p-6 border-2 border-blue-200 flex flex-col items-center text-center h-full">
              <div className="w-16 h-16 bg-blue-600 border-2 border-blue-700 flex items-center justify-center mb-6 rounded-2xl">
              ...
              <Button className="w-full bg-blue-600 border-blue-700 border text-white font-semibold">
                Avvia Chat
              </Button>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-linear-to-br rounded-4xl from-emerald-50 to-emerald-100 p-6 border-2 border-emerald-200 flex flex-col items-center text-center h-full">
              <div className="w-16 h-16 bg-emerald-600 border-2 border-emerald-700 flex items-center justify-center mb-6 rounded-2xl">
              ...
              <Button variant="outline" className="w-full bg-emerald-600! border-emerald-700 text-white font-semibold">
                +39 02 1234 5678
              </Button>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-linear-to-br rounded-4xl from-purple-50 to-purple-100 p-6 border-2 border-purple-200 flex flex-col items-center text-center h-full">
              <div className="w-16 h-16 bg-purple-600 border-2 border-purple-700 flex items-center justify-center mb-6 rounded-2xl">
                <Mail className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Email</h3>
              <p className="text-purple-950 mb-6 flex-1">
                Scrivi al nostro supporto. Risposta garantita entro 24 ore lavorative.
              </p>
              <Button variant="outline" className="w-full bg-purple-600! border-purple-700 text-white font-semibold">
...
const CTASection = () => {
  return (
    <section className="py-16 bg-[#e4870e]">
      <div className="container px-4 md:px-6 mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="flex flex-row gap-4 justify-center">
            <Button asChild variant="outline" size="lg" className="text-base px-8 rounded-full bg-transparent text-white border-white/30 hover:bg-white/10 hover:text-white">
              <Link href="/contact">
                Contattaci
              </Link>
            </Button>
            <Button asChild size="lg" className="text-base px-7! rounded-full bg-white text-gray-900 hover:bg-gray-100">
              <Link href="/pricing">
                Vedi i piani
