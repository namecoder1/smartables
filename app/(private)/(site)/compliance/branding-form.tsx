...
export function BrandingForm({ locationId, whatsappName, initialProfile, locationPhoneNumber }: BrandingFormProps) {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
      <div className="xl:col-span-3 py-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4   w-full">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  maxLength={512}
                  className="bg-muted/40 border-0 shadow-none min-h-[120px] resize-none px-4 py-3 rounded-xl"
                />
              </div>
      ...
      <div className="xl:col-span-2 bg-black/5 rounded-r-[20px] border-l pt-4 pb-0 flex flex-col h-full overflow-hidden">
