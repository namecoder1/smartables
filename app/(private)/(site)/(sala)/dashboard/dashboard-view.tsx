...
import { startOfDay, subDays, format, isWithinInterval, startOfMonth, endOfMonth, subMonths, getHours, getDay, addDays } from 'date-fns'
import { ArrowDown, ArrowUp, Settings, Minus, Link2, SquareArrowOutUpRight, Loader2 } from 'lucide-react'
  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <h3 className="text-2xl sm:text-3xl font-bold tracking-tight">Dashboard</h3>
      ...
      <div className='mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <div className='bg-card text-card-foreground rounded-3xl flex flex-col items-center gap-6 border-2 py-6 px-5 shadow-sm'>
          <div className="flex flex-col items-start xl:flex-row xl:items-center justify-between w-full gap-4">
            ...
            <div className="flex items-center gap-1 bg-zinc-100 dark:bg-zinc-800 p-1.5 rounded-xl w-full sm:w-auto overflow-x-auto no-scrollbar">
              {daysOfWeek.map((day) => (
                <button
                  ...
                  className={`
                    ...
                    ${selectedDay === day.value
                      ? 'bg-white dark:bg-zinc-700 text-foreground shadow-sm scale-110'
...
const StatCard = ({
  ...
  return (
    <div className='bg-card text-card-foreground rounded-xl flex items-start gap-2 border-2 py-5 px-4 shadow-sm min-h-[140px]'>
