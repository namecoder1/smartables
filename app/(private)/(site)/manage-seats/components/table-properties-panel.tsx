...
export function TablePropertiesPanel({ table, onUpdate, onClose, onDelete, locationSlug }: TablePropertiesPanelProps) {
  ...
  return (
    <div className="absolute top-2 right-2 w-64 rounded-xl bg-card border shadow-lg p-4 z-50 animate-in slide-in-from-right-10 fade-in duration-200 overflow-y-auto max-h-[calc(100vh-100px)]">
