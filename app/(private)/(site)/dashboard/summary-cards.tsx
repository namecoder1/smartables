...
export function SummaryCards({
  ...
  return (
    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 border-2 p-4 rounded-4xl bg-[#eeeeee]">
      <StatCard
  ...
  return (
    <Card className="group relative flex flex-col justify-between overflow-hidden rounded-3xl p-6 shadow-[0_2px_20px_-8px_rgba(0,0,0,0.05)] transition-all duration-300 hover:shadow-[0_8px_30px_-12px_rgba(0,0,0,0.1)] hover:-translate-y-0.5">
      <div className="flex items-start justify-between">
        ...
        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary/10 text-primary/70 dark:bg-zinc-800 dark:text-zinc-500 group-hover:bg-primary/10 group-hover:text-primary transition-colors duration-300">
