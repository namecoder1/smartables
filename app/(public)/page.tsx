        ...
        <div className="w-full max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2 flex flex-col gap-8">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 text-lg font-medium text-gray-800">
                    <CheckCircle2 className="text-[#da3743] w-6 h-6 shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
              ...
              <div className="pt-4">
                <Button variant="link" className="p-0 h-auto text-[#da3743] text-xl font-bold hover:no-underline hover:opacity-80 flex items-center gap-2">
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <div className="mt-8 flex items-center justify-center gap-4">
              <div className="w-12 h-12 bg-gray-200 rounded-full overflow-hidden relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-[#da3743] text-white font-bold text-xl">M</div>
              </div>
