  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <div className="w-full bg-linear-to-r border border-neutral-600 from-[#FF9710] to-[#c45012] rounded-xl p-6 shadow-xl text-white flex flex-col items-center justify-center gap-4 cursor-pointer hover:scale-[1.01] transition-transform duration-200 ring-offset-2 focus-visible:ring-2">
