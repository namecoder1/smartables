...
const NavbarSearch = () => {
  ...
  return (
    <>
      <div className='relative mr-2 py-4 hidden sm:block' onClick={() => setOpen(true)}>
        <Input
          placeholder='Cerca...'
          className='max-w-40 w-full border border-border bg-white dark:bg-input! cursor-pointer'
          readOnly
        />
